...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/Init.o ${OBJECTDIR}/_ext/1472/Interrupts.o ${OBJECTDIR}/_ext/1472/SensoredBLDC.o ${OBJECTDIR}/_ext/1472/sci_buffer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/Init.o.d ${OBJECTDIR}/_ext/1472/Interrupts.o.d ${OBJECTDIR}/_ext/1472/SensoredBLDC.o.d ${OBJECTDIR}/_ext/1472/sci_buffer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/Init.o ${OBJECTDIR}/_ext/1472/Interrupts.o ${OBJECTDIR}/_ext/1472/SensoredBLDC.o ${OBJECTDIR}/_ext/1472/sci_buffer.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../../../../Program\ Files/Microchip/MPLAB\ C30/support/dsPIC33F/gld/p33FJ32MC204.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-L"../../../../../Program Files/Microchip/MPLAB C30/support/dsPIC33F/gld",-Map="${DISTDIR}/AN957-BLDC1.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../../../../../Program\ Files/Microchip/MPLAB\ C30/support/dsPIC33F/gld/p33FJ32MC204.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-L"..",-L"../../../../../Program Files/Microchip/MPLAB C30/support/dsPIC33F/gld",-Map="${DISTDIR}/AN957-BLDC1.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/AN957-BLDC1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=elf
endif
