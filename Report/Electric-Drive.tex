...
\lstset{language=C,basicstyle =\footnotesize,tabsize=4,showspaces=false,showstringspaces=false, keywordstyle=\color{blue},commentstyle=\color{green!60!black},xleftmargin=3em,stringstyle=\color{mauve}, breaklines=true
	 }
...
\begin{spacing}{1}
	\lstinputlisting{code/1/SensoredBLDC.c}
\end{spacing}

\paragraph{Interrupts.c}
\begin{spacing}{1}
	\lstinputlisting{code/1/Interrupts.c}
\end{spacing}
...
\paragraph{SensoredBLDC.c}
\begin{spacing}{1}
	\lstinputlisting{code/2/SensoredBLDC.c}
\end{spacing}

\paragraph{Interrupts.c}
\begin{spacing}{1}
	\lstinputlisting{code/2/Interrupts.c}
\end{spacing}
...
\paragraph{SensoredBLDC.c}
\begin{spacing}{1}
	\lstinputlisting{code/3/SensoredBLDC.c}
\end{spacing}
...
\paragraph{SensoredBLDC.c}
\begin{spacing}{1}
	\lstinputlisting{code/4/SensoredBLDC.c}
\end{spacing}
\paragraph{Interrupts.c}
\begin{spacing}{1}
	\lstinputlisting{code/4/Interrupts.c}
\end{spacing}
\paragraph{sci\_buffer.h}
\begin{spacing}{1}
	\lstinputlisting{code/4/sci_buffer.h}
\end{spacing}
\paragraph{sci\_buffer.c}
\begin{spacing}{1}
	\lstinputlisting{code/4/sci_buffer.c}
\end{spacing}

\end{spacing}

\section*{心得与体会}
\addcontentsline{toc}{section}{心得与体会}
\par
